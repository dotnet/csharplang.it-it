...
Diverse funzionalità c# di aiuto nella costruzione di applicazioni affidabili e durevoli: ***Garbage collection*** recupera automaticamente la memoria occupata dagli oggetti inutilizzati. ***la gestione delle eccezioni*** offre un approccio strutturato ed estendibile al rilevamento degli errori e il ripristino; e il ***indipendente dai tipi*** progettazione del linguaggio rende impossibile leggere da non inizializzata variabili, alle matrici di indice oltre i limiti o per eseguire i cast di tipo unchecked.
